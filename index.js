...
gsap.from('.bottom_products_card', {opacity:0, delay:2.6, duration:5, ease: "elastic.out(1,0.3)", x:100});

gsap.from('.user_selected_product_img', {opacity:0, delay:3, duration:8, ease:"elastic.out(1,0.3)", y:100});
